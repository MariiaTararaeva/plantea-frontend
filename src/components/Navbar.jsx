...
const Navbar = () => {
  ...
  return (
    <nav style={{ display: "flex", justifyContent: "space-around", alignItems: "center", padding: "5px" }}>
      <img src="src/images/webicon.png" alt="Web Icon" style={{ height: "50px" }} />
      <ul style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: "10px", listStyle: "none" }}>
        <li>
          <Link to="/">Home</Link>
        </li>
